	...
	function() {
		...
		lib_methods : {
			...
			remove_data : function(t) {
				t ? (
				delete Foundation.cache[t.attr("data-" + this.name + "-id")], t.attr("data-" + this.name + "-id", "")) : e("[data-" + this.name + "-id]").each(function() {
...
})(libFuncName, this, this.document), function(e, t, n, r) {"use strict";
...
}(Foundation.zj, this, this.document), function(e, t, n, r) {"use strict";
...
}(Foundation.zj, document), function(e, t, n, r) {"use strict";
...
}(this, document, Foundation.zj), function(e, t, n, r) {"use strict";
	...
	Foundation.libs.section = {
		...
		events : function() {
			...
			e(this.scope).on("click.fndtn.section", "[data-section] .title, [data-section] [data-section-title]", function(t) {
				var n = e(this), i = n.closest(r.settings.section_selector);
	...
	Foundation.libs.topbar = {
		...
		events : function() {
			...
			e(this.scope).on("click.fndtn.topbar", ".top-bar .toggle-topbar", function(i) {
				...
				var r = e(this).closest(".top-bar"), i = r.find("section, .section"), s = r.children("ul").first(), o = e(this).next(".dropdown").outerHeight();
				(Modernizr.touch || n.breakpoint()) && t.preventDefault();
				if (n.breakpoint()) {
					var u = e(this), a = u.closest("li");
